...
export const testimonials: Testimonial[] = [
  ...
  { id: "t3", quote: "Nice detailed inspection, very clear report. On top of that, I contacted Mayne Inspectors on real short notice and they were able to reschedule their agenda, which makes them even more favorable. I highly recommend Mayne Inspectors.", name: "Serge Somers", location: "Google Review", avatarUrl: "https://placehold.co/100x100.png" },
  { id: "t4", quote: "Amazing service, he checked everything in detail. Very reasonable price and arrived on time. I will hire Mayne Inspectors again.", name: "Yasnay Tapanes", location: "Google Review", avatarUrl: "https://placehold.co/100x100.png" },
];
