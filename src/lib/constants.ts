...
export const services: Service[] = [
  ...
  { id: "4-point", slug: "4-point-inspection", name: "4-Point Inspection", description: "Focuses on four key areas: roofing, electrical, plumbing, and HVAC. Often required for insurance.", longDescription: "A 4-Point Inspection is often required by insurance companies for older homes. It focuses on the four most critical systems: HVAC (Heating, Ventilation, and Air Conditioning), Electrical wiring and panels, Plumbing connections and fixtures, and the Roof. This inspection verifies the age, condition, and functionality of these systems to satisfy insurance underwriting requirements.", icon: ClipboardCheck, image: "https://images.unsplash.com/photo-1600585153492-5a918456da4e?w=1200&q=80&auto=format&fit=crop" },
