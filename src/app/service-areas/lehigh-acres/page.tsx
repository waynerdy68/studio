...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/og/lehigh-acres-welcome-inspector.jpg", width: 1200, height: 630, alt: "Home inspector in Lehigh Acres, Florida examining property" }],
  },
  twitter: {
    ...
    images: ["/images/og/lehigh-acres-welcome-inspector.jpg"],
  },
}
...
export default function LehighAcresPage() {
  ...
  const localBusinessLd = {
    ...
    "name": BRAND,
    "image": "https://mayneinspectors.com/images/og/lehigh-acres-welcome-inspector.jpg",
    ...
    <main className="max-w-5xl mx-auto px-4 py-16">
      ...
      <section className="mt-10">
        <div className="relative mx-auto max-w-3xl rounded-xl shadow overflow-hidden" style={{ aspectRatio: "1200 / 630" }}>
          <Image 
            src="/images/og/lehigh-acres-welcome-inspector.jpg" 
